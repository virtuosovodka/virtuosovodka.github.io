...
const popupData = {
    ...
    securityplus: {
        ...
        subtitle: 'View certification and score report:',
        links: [
            {
                icon: 'securityplus',
                iconSvg: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                desc: 'CompTIA Security+ Certification (Score: 804)',
                url: './CompTIA Security+ ce certificate copy.pdf'
            },
            {
                icon: 'score',
                iconSvg: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                title: 'Score Report',
                desc: 'Official score report (804/900)',
                url: './comptia_security+_scorereport copy.pdf'
            }
        ]
    },
    greatlearning: {
